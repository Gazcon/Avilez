                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- FORMULARIO EDIT-->
                            <form class="DatPers1" method="POST" id="form_edi">
                                ...
                                <br>
                                <div>
                                    <input type="number" id="txtnumerocel" name="txtnumerocel" placeholder="# Movil" class="BotDa_Num">
                                </div>
                                <br>
                                <div>
                                ...
                                <br>
                                <div>
                                    <input type="email" id="txtemail" name="txtemail" placeholder="E-mail" class="Bot_emai">
                                    <br>
